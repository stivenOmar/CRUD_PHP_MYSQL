        ...
        <div class='row main'>
            <div class="col s12 m4 ">
                    ...
                    <?php if(isset($_SESSION['message'])){?>
                        ...
                        <a class='black-text'> <?= $_SESSION['message'] ?> </a>
                            ...
                            <tbody>
                                ...
                                while($row = mysqli_fetch_array($resultado)){?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a class='red-text' href="delete_task.php?id=<?php echo $row['id']?>"><i class='material-icons'>delete_forever</i></a>
                                        <a class='green-text' href="edit_task.php?id=<?php echo $row['id']?>"><i class='material-icons'>edit</i></a>
                                        </td>
                                    </tr>
